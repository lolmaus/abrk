...
<div id="page">
  ...
  <?php if ($page['header_top']): ?>
    <header id="header-top-wrapper" class="container-wrapper">
  ...
  <?php if ($page['header']): ?>
    <header id="header-wrapper"><div id="header-wrapper-inner" class="container-wrapper">
  ...
  <?php if ($page['subheader']): ?>
    <nav id="subheader-wrapper" class="container-wrapper">
